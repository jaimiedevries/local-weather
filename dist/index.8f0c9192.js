...
/*  Wanneer het warmer is dan 16 graden celsius dan tonen we een 'hot' theme en anders 'cold'
  middels de data attribute op de HTML pagina. */ function toggleBackgroundThema() {
    if (celsius >= 16) setThema('hot');
    else setThema('cold');
}
...
volgende element in de parent verwijderd. */ function toggleTemperatuurSchaal(event) {
